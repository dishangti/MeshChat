...
enum GeohashChannelLevel: CaseIterable, Codable, Equatable {
    ...
    var displayName: String {
        switch self {
        case .building:
            return AppLanguageSettings.localized("location_levels.building", comment: "Name for building-level location channel")
        case .block:
            return AppLanguageSettings.localized("location_levels.block", comment: "Name for block-level location channel")
        case .neighborhood:
            return AppLanguageSettings.localized("location_levels.neighborhood", comment: "Name for neighborhood-level location channel")
        case .city:
            return AppLanguageSettings.localized("location_levels.city", comment: "Name for city-level location channel")
        case .province:
            return AppLanguageSettings.localized("location_levels.province", comment: "Name for province-level location channel")
        case .region:
            return AppLanguageSettings.localized("location_levels.region", comment: "Name for region-level location channel")
        }
    }
}
