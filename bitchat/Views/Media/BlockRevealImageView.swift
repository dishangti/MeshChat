...
struct BlockRevealImageView: View {
    ...
    private enum Strings {
        static var tapToReveal: String { AppLanguageSettings.localized("media.image.tap_to_reveal", comment: "Caption on a blurred incoming image inviting a tap to reveal it") }
        static var open: String { AppLanguageSettings.localized("media.image.action.open", comment: "Context menu action that opens an image full screen") }
        static var reveal: String { AppLanguageSettings.localized("media.image.action.reveal", comment: "Context menu action that reveals a blurred image") }
        static var hide: String { AppLanguageSettings.localized("media.image.action.hide", comment: "Context menu action that re-blurs a revealed image") }
        static var delete: String { AppLanguageSettings.localized("media.image.action.delete", comment: "Context menu action that deletes a received image") }
        static var deleteConfirmTitle: String { AppLanguageSettings.localized("media.image.delete_confirm_title", comment: "Title of the confirmation dialog before deleting a received image") }
        static var deleteConfirmMessage: String { AppLanguageSettings.localized("media.image.delete_confirm_message", comment: "Body of the confirmation dialog before deleting a received image") }
        static var hiddenImage: String { AppLanguageSettings.localized("media.image.accessibility.hidden", comment: "Accessibility label for a blurred incoming image") }
        static var revealedImage: String { AppLanguageSettings.localized("media.image.accessibility.revealed", comment: "Accessibility label for a revealed image") }
        static var revealHint: String { AppLanguageSettings.localized("media.image.accessibility.hint.reveal", comment: "Accessibility hint for a blurred image; activating it reveals the image") }
        static var openHint: String { AppLanguageSettings.localized("media.image.accessibility.hint.open", comment: "Accessibility hint for a revealed image; activating it opens the image full screen") }
        static var sendingImage: String { AppLanguageSettings.localized("media.image.accessibility.sending", comment: "Accessibility label for an image that is still sending") }
        static var unavailableImage: String { AppLanguageSettings.localized("media.image.accessibility.unavailable", comment: "Accessibility label for an image whose file could not be loaded") }
        static var cancelSend: String { AppLanguageSettings.localized("media.accessibility.cancel_send", comment: "Accessibility label for the cancel button on an in-flight media send") }
    }
